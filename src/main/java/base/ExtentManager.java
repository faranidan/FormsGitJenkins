...
public class ExtentManager extends BasePage {
	...
	public static ExtentReports setupExtentReport(String testName) {
		...
		extentReport.setSystemInfo("Tester", "Idan F.");
		spark.config().setReportName("Automation Testing for Ficx-Studio");
	...
	public static String extentReportsPrefix_Name (String testName) {
		...
		extentReportPrefix = testName + "___" + date;
	...
	public synchronized static ExtentTest creatTest(String name, String description) {
	...
	public synchronized static void attachImage() {
		getTest().addScreenCaptureFromPath(getScrnShtDestPath());
	}
}
